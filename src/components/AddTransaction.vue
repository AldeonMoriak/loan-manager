<template>
  ...
  <ModalContainer :is-shown="props.isShown">
    <form @submit.prevent="insertTransaction" ref="target" :class="store.dir === 'rtl' ? 'text-right' : 'text-left'"
      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="flex flex-col">
          <div class="text-xl font-bold text-gray-500 mb-4">{{ store.dir === 'rtl' ? 'افزودن قسط' : 'New Transaction' }}
          </div>
          <div id="loans mt-5">
            ...
            <input type="text" dir="auto" id="loan-name" disabled
          ...
          <div id="name" class="mt-4">
            ...
            <input type="text" dir="auto" ref="input" id="transaction-name"
          ...
          <div id="amount" class="mt-4">
            ...
            <input type="number" id="transaction-amount" v-model="form.amount"
