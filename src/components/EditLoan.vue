<template>
  ...
  <ModalContainer :is-shown="props.isShown">
    <form @submit.prevent="editLoan" ref="target" :class="store.dir === 'rtl' ? 'text-right' : 'text-left'"
      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="flex flex-col">
          <div class="text-xl font-bold text-gray-500 mb-4">{{ store.dir === 'rtl' ? 'ویرایش وام' : 'Edit Loan' }}</div>
          <div id="loans mt-5">
