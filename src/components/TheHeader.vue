...
<template>
  <div
    ...
    class="
      ...
      transition-colors
      duration-500
      lg:z-50 lg:border-b lg:border-gray-900/10
  ...
  >
    <div @click="toggleDark()" class="mx-4 pt-4 cursor-pointer">
      <div
        v-if="isDark"
        class="bg-yellow-100 hover:bg-yellow-50 rounded p-2 inline-block"
      >
        <svg
          width="24"
          height="24"
      ...
      <div
        v-else
        class="bg-gray-700 hover:bg-gray-500 rounded p-2 inline-block"
      >
        <svg
          width="24"
          height="24"
    ...
    <div class="mx-4 pt-4">
      <div class="flex items-center">
        ...
        <p class="mr-4 dark:text-white text-gray-800 font-medium">
          {{ store.dir === "rtl" ? "فارسی" : "English" }}
        </p>
      </div>
    </div>
  </div>
